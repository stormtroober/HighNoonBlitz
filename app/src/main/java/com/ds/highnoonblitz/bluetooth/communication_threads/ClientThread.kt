        ...
        while (attempt < maxAttempts) {
            try {
                ...
                if (attempt < maxAttempts) {
                    ...
                    ToastMaker.makeToast("Trying again to connect to ${device.name}. Attempt $attempt")
                } else {
                    // Handle failure to connect after maxAttempts
                    ToastMaker.makeToast("Failed to connect to ${device.name} after $maxAttempts attempts")
                }
            }
        }
    }
